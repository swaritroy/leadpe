...
import { RAZORPAY_KEY_ID, MONTHLY_PRICE } from "@/lib/constants";
        ...
        modal: {
          ondismiss: () => {
            ...
            toast({
              ...
              description: "Payment failed or cancelled. Please try again.",
              variant: "destructive",
            });
          },
        },
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F5FFF7", fontFamily: font.body }}>
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          {/* Pay Online — Razorpay only */}
          <div className="bg-white rounded-2xl mb-5 p-5" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.08)" }}>
            <h3 style={{ fontFamily: font.heading, fontSize: 18, fontWeight: 700, color: "#1A1A1A", marginBottom: 2 }}>Pay Online</h3>
            <p style={{ fontSize: 12, color: "#999", marginBottom: 12 }}>UPI • Cards • Net Banking • Wallets</p>
