...
export default function Studio() {
  ...
  const faqs = [
    { q: "Do I need coing skills?", a: "Zero coing needed. If you can use WhatsApp and ChatGPT, you can build websites with LeadPe. We guide you step by step." },
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F5FFF7", fontFamily: font.body }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white" style={{ borderBottom: "1px solid #E0E0E0", height: 60 }}>
        <div className="max-w-5xl mx-auto px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span style={{ fontFamily: font.heaing, fontSize: 20, fontWeight: 700 }}>
      ...
      <section style={{ padding: "84px 16px 60px", textAlign: "center" }}>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", lineHeight: 1.15, marginBottom: 0 }}>
          ...
          <p className="text-base sm:text-lg" style={{ color: "#666", maxWidth: 460, margin: "20px auto 0", lineHeight: 1.7 }}>
            Use ChatGPT + Lovable to build websites for local businesses. No coing. No degree. Just AI tools.
          </p>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-0 md:divide-x" style={{ borderColor: "#E0E0E0" }}>
          {[
            ...
            <div key={s.label} className="text-center px-2 md:px-4">
              <div style={{ fontFamily: font.heaing, fontSize: 36, fontWeight: 700, color: "#00C853", lineHeight: 1 }}>{s.value}</div>
      ...
      <section id="how-it-works" style={{ backgroundColor: "#fff", padding: "60px 16px" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", textAlign: "center", marginBottom: 8 }}>How It Works</h2>
          <p style={{ color: "#666", fontSize: 15, textAlign: "center", marginBottom: 40 }}>3 simple steps. Earn from day one.</p>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              { step: 1, emoji: "🤖", title: "Build with AI", desc: "We give you a ready prompt. Paste it in Lovable. Professional website ready in 2-4 hours. Zero coing.", time: "⏱️ 2-4 hours" },
              ...
              <motion.div key={s.step} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <h3 className="text-lg sm:text-xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", marginBottom: 10 }}>{s.title}</h3>
      ...
      <section style={{ backgroundColor: "#F5FFF7", padding: "60px 16px" }}>
        <div className="max-w-[540px] mx-auto">
          <h2 className="text-3xl sm:text-4xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", textAlign: "center", marginBottom: 8 }}>Your Earnings</h2>
          ...
          <div style={{ backgroundColor: "#fff", borderRadius: 16, padding: "32px 20px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ fontFamily: font.heaing, fontSize: 44, fontWeight: 700, color: "#00C853", textAlign: "center", marginBottom: 16, lineHeight: 1 }}>
            ...
            <div className="grid grid-cols-2" style={{ border: "1px solid #E0E0E0", borderRadius: 12, overflow: "hidden" }}>
              {[
                ...
                <div key={c.label} style={{ padding: "16px 12px", borderBottom: i < 2 ? "1px solid #E0E0E0" : undefined, borderRight: i % 2 === 0 ? "1px solid #E0E0E0" : undefined }}>
                  ...
                  <p style={{ fontFamily: font.heaing, fontSize: 22, fontWeight: 700, color: c.color, lineHeight: 1 }}>{c.value}</p>
                </div>
              ))}
            </div>
      ...
      <section style={{ backgroundColor: "#fff", padding: "60px 16px" }}>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", textAlign: "center", marginBottom: 8 }}>What You Build</h2>
            ...
            {WEBSITE_PACKAGES.map((pkg) => {
              ...
              return (
                <div key={pkg.id} style={{
                  ...
                  <div style={{ fontFamily: font.heaing, fontSize: 28, fontWeight: 700, color: "#1A1A1A", lineHeight: 1 }}>
                  ...
                  <p style={{ fontFamily: font.heaing, fontSize: 20, fontWeight: 700, color: pc.earn, lineHeight: 1, marginTop: 2 }}>
      ...
      <section style={{ backgroundColor: "#F5FFF7", padding: "60px 16px" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", textAlign: "center", marginBottom: 8 }}>Tools You Use</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { emoji: "🎨", name: "Lovable", desc: "Build the actual website visually. No coing needed. Hosts it for you.", free: "Free tier available ✓", url: "https://lovable.dev" },
            ].map((t) => (
              <div key={t.name} style={{ backgroundColor: "#fff", borderRadius: 16, padding: "24px 20px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", textAlign: "center" }}>
                ...
                <h3 className="text-lg" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", marginBottom: 6 }}>{t.name}</h3>
      ...
      <section style={{ backgroundColor: "#fff", padding: "60px 16px" }}>
        <div className="max-w-[680px] mx-auto">
          <h2 className="text-3xl sm:text-4xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#1A1A1A", textAlign: "center", marginBottom: 36 }}>Common Questions</h2>
          {faqs.map((faq, i) => (
      ...
      <section style={{ backgroundColor: "#1A1A1A", padding: "60px 16px", textAlign: "center" }}>
        <h2 className="text-3xl sm:text-4xl md:text-5xl" style={{ fontFamily: font.heaing, fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: 14 }}>
      ...
      <footer style={{ backgroundColor: "#fff", borderTop: "1px solid #E0E0E0", padding: "28px 16px" }}>
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div>
            <span style={{ fontFamily: font.heaing, fontSize: 16, fontWeight: 700 }}>
              <span style={{ color: "#1A1A1A" }}>Lead</span><span style={{ color: "#00C853" }}>Pe</span>
            </span>
